...
import { Lightbulb, BookOpen, Rocket, ArrowRight } from "lucide-react"
...
const steps = [
  {
    ...
    description:
      "Проводим бесплатное вводное занятие: выявляем пробелы в знаниях, определяем цели и составляем индивидуальный план подготовки под ваш уровень и сроки.",
    number: "01",
  },
  {
    icon: BookOpen,
    title: "Системные занятия",
    description:
      "Занимаемся по чёткой программе: теория, практика, разбор ошибок. Каждое занятие — шаг вперёд. Домашние задания закрепляют пройденный материал.",
    number: "02",
  },
  {
    icon: Rocket,
    ...
    description:
      "Пробные экзамены, работа над слабыми местами и психологическая подготовка к экзамену. Выходим на экзамен уверенными и готовыми к высокому результату.",
    number: "03",
  },
]
      ...
      <div className="container mx-auto max-w-7xl relative z-10">
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-6 text-balance">
            От <span className="text-primary">первого урока</span> до <span className="text-primary">отличного результата</span>
          </h2>
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto text-pretty leading-relaxed">
            Три шага, которые превращают страх перед экзаменом в уверенность и высокий балл.
          </p>
        </div>
